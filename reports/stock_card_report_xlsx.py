...
class ReportStockCardReportXlsx(models.AbstractModel):
    ...
    def _stock_card_report(self, wb, ws, ws_params, data, objects, product):
        ...
        # Usa los datos pre-agrupados — sin filtered() ORM
        balance = objects._get_product_initial(product)
        row_pos = self._write_line(
            ws,
            row_pos,
            ws_params,
        ...
        for line in objects._get_product_lines(product):
            ...
            row_pos = self._write_line(
                ...
                render_space={
                    "date": line.date or "",
                    "operation": line.picking_type_name or "",
                    "reference": line.display_name or "",
                    "source": line.picking_origin or "",
                    "partner": line.partner_name or "",
